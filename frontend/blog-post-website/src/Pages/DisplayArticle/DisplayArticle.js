...
export default function DisplayArticle() {
    ...
    useEffect(() => {
    //   axiosInstance1.get("/articles/show/4").then((d)=>{
    //     console.log(d.data)
  ...
  return (
    <div>
        ...
        <div className={styles.middleContainer1}>
            {/* <p>Updated On <Moment date={data?.updated_at} format="D MMM YYYY" /></p> */}
            ...
            <p className={styles.headCategory}>Programming Languages</p>
        </div>
