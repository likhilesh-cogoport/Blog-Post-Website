        ...
        <div className={styles.blogsContainer}>
            <div className={styles.leftContainer}>
                <div className={styles.searchContainer}>
                    ...
                    <input placeholder='Search Articles' className={classes.input_type1}
                    style={{width:'200px',padding:'4px', marginBottom:'20px'}}
                    />
                    <div>
                            ...
                            <div key={'article-card'+article.id} className={styles.cards}>
                                ...
                                <div className={styles.cardData}>
                                    ...
                                    <div className={styles.interactionBar}>
                                        ...
                                        <button onClick={()=>gotoDetialsPage(article)} className={classes.btn_type2} style={{zoom:'0.75'}}>
                                            Read More&nbsp;
                                            <RxOpenInNewWindow/>
                                        </button>
                                    </div>
